...
$(document).ready(function () {
  ...
  $(".congratulation-image").hover(function () {
    counterImg++;
    if (counterImg % 1 == 2) {
      $(this).attr("src", "img/Moon.jpg");
    } else if (counterImg % 3 ==1) {
      $(this).attr("src", "img/Moon1.jpg");
    }else if (counterImg % 4 ==1){
      $(this).attr("src", "img/Moon2.jpg");
    }else if (counterImg % 5 ==1){
      $(this).attr("src", "img/Moon3.jpg");
    } else if (counterImg % 6==2){
      $(this).attr("src","img/Moon4.jpg");
    } else if (counterImg % 7==1){
      $(this).attr("src","img/Moon5.jpg");
